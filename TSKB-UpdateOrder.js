function updateOrder(){
    ...
    if (!document.getElementById("updateOrder").value){
        alert("To update your order, please enter a value.");
        document.getElementById("updateOrder").focus();
        document.getElementById("updateOrder").select();
        return false;
    }
}  